...
abstract contract SessionKeyManager is Auth {
    ...
    function setSssionKeyMerkleRoot(bytes32 newSessionKeyMerkleRoot) public onlySelf {
        bytes32 oldSessionKeyMerkleRoot = _getSessionKeyMerkleRoot();
        AccountStorage.layout().sessionKeyMerkleRoot = newSessionKeyMerkleRoot;
        emit SessionKeyChanged(newSessionKeyMerkleRoot, oldSessionKeyMerkleRoot);
    }
     ...
     */
    function _getSessionKeyMerkleRoot() internal view returns (bytes32) {
